...
![My Skills](https://skillicons.dev/icons?i=js,ts,vue,react,astro,nextjs,bun,nodejs,python,fastapi,go,git,github,vscode,vite,rust,docker,redis,sqlite,postgresql,vercel,aws)
